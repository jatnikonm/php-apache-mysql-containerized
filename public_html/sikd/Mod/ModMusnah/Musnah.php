...
<script type="text/javascript" charset="utf-8">
	document.getElementById("title").innerHTML = 'Berita Acara Pemusnahan Arsip';
...
function ltblberkas(a,b){
       ...
       var id = $("#id").val();
      if(task=='edit')
      R_url = 'Mod/ModMusnah/bantai2.php?id='+id+'&task='+b;
      else
      R_url = 'Mod/ModMusnah/bantai2.php?NoS='+a+'&task='+b;
...
function loadtblusul(){
   oTable = $('#tblusul').dataTable({
			...
			"bServerSide": true,
			"aaSorting": [[5, "asc"]],
			"sAjaxSource": "Mod/ModMusnah/bantai1.php"
		});
	...
	<div id="pnlDetails" style="display:none">
		<table style="width:100%;" class="tb_grid" cellpadding="2" cellspacing="0">
           ...
           <tr>
            ...
            <tr>
				<td style="width:10%;" valign="top"> No. Surat Usul Musnah <font color="red">*</font></td>
				<td style="width:90%;">
