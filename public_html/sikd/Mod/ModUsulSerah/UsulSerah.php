...
<script type="text/javascript" charset="utf-8">
	document.getElementById("title").innerHTML = 'Pengajuan Surat Permohonan Usul Serah Arsip Statis';
...
function ltblberkas(id,role){
       var R_url;
       var task = $("#task").val();
       //var id = $("#id").val();
      R_url = 'Mod/ModUsulSerah/bantai2.php?id='+id+"&task="+task+"&role="+role;
...
function loadtblusul(){
   oTable = $('#tblusul').dataTable({
			...
			"bServerSide": true,
			"aaSorting": [[5, "asc"]],
			"sAjaxSource": "Mod/ModUsulSerah/bantai1.php"
		});
