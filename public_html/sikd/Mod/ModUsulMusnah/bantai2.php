...
session_start();
    ...
    $ddr = "select berkasid from permohonan_musnah where idmusnah = '$id'";
	} else {
    $ddr = "select berkasid from permohonanusul where status='up' and ket = 'OK'"; }
