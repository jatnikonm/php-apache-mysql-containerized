...
<!--				<li><a href="#tab4" style="display:<?php echo $tab4; ?>">Relasi Naskah</a></li>  
					...
					<script type="text/javascript" charset="utf-8">
                        $(document).ready(function() {
                            $('#example212').dataTable({
                                ...
                                "bServerSide": true,
                                "aaSorting": [[1, "desc"]],
                                "sAjaxSource": "Mod/ModMailTLBerkas/bantai2.php?id=<?php echo "$_GET[id]"; ?>"
                            });
					...
					<script type="text/javascript" charset="utf-8">
                        $(document).ready(function() {
                            $('#example21').dataTable({
                                ...
                                "bServerSide": true,
                                "aaSorting": [[1, "desc"]],
                                "sAjaxSource": "Mod/ModMailTLBerkas/bantai1.php?id=<?php echo "$_GET[id]"; ?>"
                            });
