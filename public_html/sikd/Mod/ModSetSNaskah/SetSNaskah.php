...
<script type="text/javascript">
	document.getElementById("title").innerHTML = 'Pengaturan Umum -> Sifat Naskah';
</script>
...
<div class="content-main-popup">
	<div id="pnlDetails" style="display:none">
		<table style="width:100%;" class="tb_grid" cellpadding="2" cellspacing="0">
			<tr>
				<td style="width:20%;"> Sifat Naskah <font color="red">*</font></td>
				<td style="width:80%;">
					<input type="text" name="txt1" class="inputbox" style="width:50%;">&nbsp;
	...
	<table class="adminlist" style="width:100%" cellpadding="2" cellspacing="0" >
		<tr style="color:White;background-color:#666699;height:24px;">
			<th style="width:1%">No</th>
			<th style="width:1%"><input type="checkbox" onClick="changeCheckState(this.checked);"></th>
			<th style="width:1%">&nbsp;</th>
			<th style="width:97%">Sifat Naskah</th>
		</tr>
		<?php
			$no = $startrec;
			for ($i = $startrec; $i < $reccount; $i++)
			{
				...
				<tr style="background-color:<?php echo $bg; ?>">
					<td><?php echo $no; ?></td>
					<td><input type="checkbox" name="ids[]" value="<?php echo $row["SifatId"]; ?>" /></td>
					<td><a href="#" onclick="setDetails('edit','<?php echo $row["SifatId"] . '|' . $row["SifatName"]; ?>')"><img src="images/edit.png" border="0" /></a></td>
					<td><?php echo $row["SifatName"]; ?></td>
				</tr>
				<?php }					
