...
session_start();
	...
	$n=1;
    $ddr = "select berkasid, ket from permohonanusul where RoleId = '".$_SESSION['PrimaryRoleId']."' and PermohonanId='".$id."' and status='up' and ket<>'OK'";
