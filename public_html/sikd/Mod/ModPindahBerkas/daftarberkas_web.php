	...
	<div class="content-main-report">
		<table width="100%" cellpadding="0" cellspacing="0">
			<tr>
				<td style="text-align:center;">
					<h2><b>DAFTAR BERKAS USUL&nbsp;PINDAH</b></h2>
				</td>
			</tr>
			<tr>
				<td style="text-align:center;">
		...
		<table width="100%" class="tb_report" cellspacing="0" style="border:#000000 1px solid;">
			<tr>
				...
				<th width="3%" style="padding:0.4em; border-right: #000000 solid 1px;border-bottom: #000000 solid 1px;">Jumlah Item</th>
				<th width="15%" style="padding:0.4em; border-right: #000000 solid 1px;border-bottom: #000000 solid 1px;">Unit Kerja</th>
			</tr>
			<?php
            $sql = "SELECT berkasid FROM permohonanusul where permohonanid='$ids'";
			$res = mysql_query($sql);
            ...
            $sql = "SELECT
                        ...
                        berkas.BerkasNumber,
                        berkas.BerkasName,
                        Count(inbox.NId) as jml_item,
                        role.RoleName
                        FROM
                        berkas
                        left Join inbox ON berkas.BerkasId = inbox.BerkasId
			...
			while($row = mysql_fetch_array($res)){
			  ...
			  ?>
					...
					<td style="padding:0.4em; border-right: #000000 solid 1px;border-bottom: #000000 solid 1px;"><center><?php echo $row[0]."/".$row[1]; ?></center></td>
					<td style="padding:0.4em; border-right: #000000 solid 1px;border-bottom: #000000 solid 1px;"><?php echo $row[2]; ?></td>
					<td style="padding:0.4em; border-right: #000000 solid 1px;border-bottom: #000000 solid 1px;" align="right"><?php echo $row[3]; ?>&nbsp;Item</td>
