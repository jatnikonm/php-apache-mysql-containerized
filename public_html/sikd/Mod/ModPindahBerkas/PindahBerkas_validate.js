...
<script type="text/javascript">
 ...
 $(function(){
	...
	function confirmValidate(){
        ...
        if(document.forms.form1.thn1.value==""){
          document.getElementById("req4").style.display = 'inline';
          validasi = false;
        }else{
          if (document.forms.form1.thn1.value > document.forms.form1.thn2.value){
          document.getElementById("req4").style.display = 'inline';
          validasi = false; }
        }
...
//		}
    ...
    function load_BA(ids){
       window.location.href="index2.php?option=beritaacara&mod=up&ids="+ids;
    }

    function editBA(ids){
       window.location.href="index2.php?option=beritaacara&mod=up&req=edit&ids="+ids;
    }
    function hapusBA(ids){
    tanya = confirm("Apakah Berita Acara ini akan dihapus ?");
      if (tanya)
        window.location.href="index2.php?option=beritaacara&req=delete&ids="+ids;
      else
        return false;

    }

//    function daftar_usulberkas(mod, ids){
//      alert();
//       window.location.href="mod/modpidahberkas/daftarberkas_web.php?task=+"mod"+&ids="+ids;
//    }
</script>