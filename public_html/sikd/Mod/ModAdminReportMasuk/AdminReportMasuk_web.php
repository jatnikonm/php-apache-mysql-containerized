	...
	<div class="content-main-report">
		<table width="100%" cellpadding="0" cellspacing="0">
			<tr>
				<td style="text-align:center;">
					<h2><b>LAPORAN NASKAH MASUK</b></h2>
				</td>
			</tr>
			<tr>
				<td style="text-align:center;">
		...
		<table width="100%" class="tb_report" cellspacing="0" style="border:#000000 1px solid;">
			<tr>
				...
				<th width="8%" style="padding:0.4em; border-right: #000000 solid 1px;border-bottom: #000000 solid 1px;">Tanggal Naskah Masuk</th>
            ...
            $sql = "SELECT 
                    ...
                    WHERE RoleId_To = '$_SESSION[PrimaryRoleId]' and ";
