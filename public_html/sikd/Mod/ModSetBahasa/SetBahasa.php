...
<script type="text/javascript">	
	document.getElementById("title").innerHTML = 'Pengaturan Umum -> Bahasa';
</script>
...
<div class="content-main-popup">
	<div id="pnlDetails" style="display:none">
		<table style="width:100%;" class="tb_grid" cellpadding="2" cellspacing="0">
			<tr>
				<td style="width:10%;"> Bahasa <font color="red">*</font></td>
				<td style="width:90%;">
		...
		<?php
			...
			for ($i = $startrec; $i < $reccount; $i++)
			{
				...
				<tr style="background-color:<?php echo $bg; ?>">
					<td><?php echo $no; ?></td>
					<td><input type="checkbox" name="ids[]" value="<?php echo $row["LangId"]; ?>" /></td>
					<td><a href="#" onclick="setDetails('edit','<?php echo $row["LangId"] . '|' . $row["LangName"]; ?>')"><img src="images/edit.png" border="0" /></a></td>
					<td><?php echo $row["LangName"]; ?></td>
				</tr>
				<?php							
			}					
