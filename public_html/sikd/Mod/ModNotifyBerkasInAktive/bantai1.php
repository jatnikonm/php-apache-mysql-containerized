...
session_start();
	 ...
	 */
	$aColumns = array( 'BerkasId', 'BerkasStatus', 'BerkasNumber', 'BerkasName', 'RetensiValue_InActive', 'RoleDesc' );
	...
	while ( $aRow = mysql_fetch_array( $rResult ) )
	{
		...
		for ( $i=0 ; $i<count($aColumns) ; $i++ )
		{
            ...
            elseif ( $aColumns[$i] == 'RetensiValue_InActive' )
            {
				...
				$row[] .= ''."<a href=index2.php?option=MailBerkas&id=$BerkasId style='text-decoration:none'>$RetensiValue_InActive</a>".'';				 
			}		
