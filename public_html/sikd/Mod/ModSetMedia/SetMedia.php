...
<script type="text/javascript">
	document.getElementById("title").innerHTML = 'Pengaturan Umum -> Media Arsip';
</script>
...
<div class="content-main-popup">
	<div id="pnlDetails" style="display:none">
		<table style="width:100%;" class="tb_grid" cellpadding="2" cellspacing="0">
			<tr>
				<td style="width:20%;"> Media Arsip <font color="red">*</font></td>
				<td style="width:80%;">
	...
	<table class="adminlist" style="width:100%" cellpadding="2" cellspacing="0" >
		<tr>
			...
			<th style="width:1%">&nbsp;</th>
			<th style="width:97%">Media Arsip</th>
		</tr>
		<?php
			$no = $startrec;
			for ($i = $startrec; $i < $reccount; $i++)
			{
				...
				<tr style="background-color:<?php echo $bg; ?>">
					<td><?php echo $no; ?></td>
					<td><input type="checkbox" name="ids[]" value="<?php echo $row["MediaId"]; ?>" /></td>
					<td><a href="#" onclick="setDetails('edit','<?php echo $row["MediaId"] . '|' . $row["MediaName"]; ?>')"><img src="images/edit.png" border="0" /></a></td>
