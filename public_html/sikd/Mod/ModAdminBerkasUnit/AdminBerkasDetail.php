...
<script type="text/javascript">
	document.getElementById("title").innerHTML = 'Entry Berkas Unit Kerja';
</script>
		...
		<tr>
			<td>
				<table cellspacing="2px" cellpadding="3px" width="100%">
					<tr>
						<td style="width:26%;" class="tabel-upload-label">
					...
					<tr>
						...
						<td>
							...
							<input type="hidden" name="txt2" value="<?php echo $data[3]; ?>" />
					...
					<tr>
						...
						<td>
							<input type="text" name="txt3" readonly="readonly" value="<?php echo $data[17]; ?>." 
								style="border:0px; min-width:40px; width:15%; " />&nbsp;
							<input type="text" name="txt4" 
							<?php if($task=="edit") echo "disabled"; ?> value="<?php echo str_replace($data[17] . ".", "", $data[4]); ?>" 
					...
					<tr>
						...
						<td>
							<input type="text" name="txt5" value="<?php echo $data[5]; ?>" 
							...
							<div style="width:90%; float:left;">
								<table width="100%" style="font-size:10px;">
									...
									<tr valign="middle">
										<?php
											if($data[6] == "tgl"){
												$tgl1 = strftime('%d/%m/%Y', strtotime($data[7]));
												$rdTgl1Sp = "";
												$rdTgl1 = 'checked="checked"';
											}else{
												$tgl1_sp = split('/', $data[6]);
									...
									<tr valign="middle">
										<?php
											if($data[8] == "tgl"){
												$tgl2 = strftime('%d/%m/%Y', strtotime($data[9]));
												$rdTgl2Sp = "";
												$rdTgl2 = 'checked="checked"';
											}else{
												$tgl2_sp = split('/', $data[8]);
					...
					<tr>
						...
						<td>
							<input type="text" name="txt8" value="<?php echo $data[11]; ?>" style="width:80%;" maxlength="250" />
						</td>
					</tr>
					<tr>
						...
						<td valign="top">
							<textarea name="txt9" rows="3" style="width:80%"><?php echo $data[12]; ?></textarea>&nbsp;
						</td>
					</tr>
				</table>
			</td>
