...
<script type="text/javascript">
	...
	function setBerkas(str){		
		var val = str.split("|");
		document.forms.form1.txt2.value = val[0];
		document.forms.form1.txt3.value = val[1] + ".";
		document.forms.form1.thn.value = val[2];
		document.forms.form1.thn2.value = val[3];
        document.forms.form1.txt7.value = val[4];
