		...
		<table width="100%" cellpadding="0" cellspacing="0">
			<tr>
				<td style="text-align:center;">
					<h2><b>LAPORAN REGISTRASI NASKAH TANPA TINDAKLANJUT</b></h2>
				</td>
			</tr>
			<tr>
				<td style="text-align:center;">
		...
		<table width="100%" class="tb_report" cellspacing="0" style="border:#000000 1px solid;">
            ...
            $sql = "SELECT 
                    ...
                    (case inbox_receiver.ReceiverAs
                      when 'to_tl' then 'Surat Masuk Tanpa Tindaklanjut'
                    ...
                    WHERE CreationRoleId = '$_SESSION[PrimaryRoleId]' and inbox_receiver.ReceiverAs = 'to_tl' and ";

            if(!empty($tgl1) and !empty($tgl2))
            $sql .= "(inbox.Tgl between '" . mkdate($tgl1) . "' and '" . mkdate($tgl2) . "') ";
