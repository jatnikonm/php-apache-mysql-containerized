...
<script type="text/javascript">
	$(document).ready(function() {
		...
		$("#txt_kepada2").tokenInput("Share/Lookup/listPeopleDispo.php", {
					theme: "facebook",
					preventDuplicates: true,
...
<form id="form1" name="form1" method="post" action="handle.php" target="MyWindowDetail">
	<input type="hidden" name="lookup" value="<?php echo $lookup; ?>" />
             ...
             <tr>
                ...
                <td>
                    <div style="width:90%; height:140px; max-height:140px; overflow:scroll; border:none;">
                        <ul class="dolorsit">
                            <?php 
								$x = mysql_query("SELECT people.RoleAtasan, role.gjabatanId from people join role on role.RoleId = people.PrimaryRoleId WHERE people.PrimaryRoleId = '" . $_SESSION["RoleAtasan"] . "' and people.GroupId = '3' ORDER BY role.gjabatanId ASC, people.PeoplePosition desc");
								$z = mysql_fetch_array($x);
                                
                                $isiDisp = explode("|", $data[6]);
                                $sqlIsi = "select DisposisiId, DisposisiName
                                            from master_disposisi
                                            where gjabatanId = '$z[gjabatanId]' and DisposisiId like '" . $_SESSION["AppKey"] . "%'
		...
		<tr>
            ...
            <td>
                <div style="width:90%; height:170px; max-height:170px; overflow:scroll; border:none;">
                    ...
                    <?php 
                        $sqlIsitujuan = "SELECT people.PeopleId, people.PeopleName, people.PeoplePosition, role.gjabatanId from people join role on role.RoleId = people.PrimaryRoleId WHERE people.RoleAtasan = '" . $_SESSION["RoleAtasan"] . "' and people.PrimaryRoleId != '" . $_SESSION["RoleAtasan"] . "' and people.PeopleIsActive='1' and people.PeopleId != '" . $_SESSION["PeopleID"] . "' 
                        ...
                        ?>
                          ...
                          <li>  
                          		<table cellspacing="0" cellpadding="0">
                                    <tr>
                                    	<td valign="top"><input type="checkbox" name="txt_kepada[]" id="txt_kepada[]" value="<?php echo $hasil['PeopleId']?>"></td>
                                    	<td><?php echo $hasil['PeoplePosition']?> </td>
                                    </tr>  
                                </table>      
                          </li>                      
		...
		<tr>
			<td valign="top">
				Tujuan Disposisi Lainnya 
			</td>
			<td>
                <div style="max-height:95px; overflow:scroll;">
		            <input type="text" id="txt_kepada2" name="txt_kepada2" class="input" style="width:80%" />
                </div>    
			</td>
		</tr>
