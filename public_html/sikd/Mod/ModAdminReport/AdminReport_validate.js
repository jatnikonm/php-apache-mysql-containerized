...
<script type="text/javascript" >
	function OpenReport(){
		var jlap = document.forms.form1.txt1.value;
		var tgl1 = document.forms.form1.txt2.value;
		var tgl2 = document.forms.form1.txt3.value;
		window.open('Mod/ModAdminReport/AdminReport_web.php?jlap=' + jlap + '&tgl1=' + tgl1 + '&tgl2=' + tgl2, 'myReport', 
				'Height=380px,Width=1024px,resizable=yes,status=no,scrollbars=yes');
	}
</script>