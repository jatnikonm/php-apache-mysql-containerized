...
<script type="text/javascript">
	document.getElementById("title").innerHTML = 'Pengaturan Umum -> Tingkat Perkembangan';
</script>
...
<div class="content-main-popup">
	<div id="pnlDetails" style="display:none">
		<table style="width:100%;" class="tb_grid" cellpadding="2" cellspacing="0">
			<tr>
				<td style="width:23%;"> Tingkat Perkembangan <font color="red">*</font></td>
				<td style="width:77%;">
	...
	<table class="adminlist" style="width:100%" cellpadding="2" cellspacing="0" >
		<tr>
			...
			<th style="width:1%">&nbsp;</th>
			<th style="width:97%">Tingkat Perkembangan</th>
		</tr>
		<?php $no = $startrec;
			for ($i = $startrec; $i < $reccount; $i++)
			{
				...
				<tr style="background-color:<?php echo $bg; ?>">
					<td><?php echo $no; ?></td>
					<td><input type="checkbox" name="ids[]" value="<?php echo $row["TPId"]; ?>" /></td>
					<td><a href="#" onclick="setDetails('edit','<?php echo $row["TPId"] . '|' . $row["TPName"]; ?>')"><img src="images/edit.png" border="0" /></a></td>
